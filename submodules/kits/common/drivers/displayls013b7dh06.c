...
#ifndef SHARP_MEMLCD_POWER_RAMP_US
#error  "Power ramp must be defined in application config"
#endif
                                 ...
                                 unsigned int           height)
{
  ...
  for (i = 0; i < height; i++) {
    /* Clear line */
    memset(pByte, 0, LS013B7DH06_WIDTH * LS013B7DH06_BITS_PER_PIXEL / 8);
