...
typedef struct {
  ...
  uint32_t       RESERVED8[5];          /**< Reserved for future use **/
  __IOM uint32_t BUCTRL;                /**< Backup power configuration register  */

  uint32_t       RESERVED9[11];         /**< Reserved for future use **/
  ...
  uint32_t       RESERVED10[4];         /**< Reserved for future use **/
