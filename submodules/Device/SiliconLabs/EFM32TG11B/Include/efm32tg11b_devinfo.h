...
typedef struct {
  ...
  uint32_t      RESERVED0[11];    /**< Reserved for future use **/
  ...
  uint32_t      RESERVED7[10];    /**< Reserved for future use **/
  ...
  uint32_t      RESERVED11[10];   /**< Reserved for future use **/
